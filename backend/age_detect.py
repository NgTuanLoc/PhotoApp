...
def detect_faces(cascade, test_image, scaleFactor = 1.1):
    ...
    for i, (x, y, w, h) in enumerate(faces_rect):
        cv.imwrite("./data/faces/face_{i}.png".format(i=i), image_copy[y:y+h, x:x+w])
...
def read_image(image_path):
    ...
    detect_faces(haar_cascade_face, image)

    for img in os.listdir("./data/faces"):
      temp_image = cv.imread("./data/faces/"+img) 
